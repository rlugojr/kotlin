...
object KotlinToJVMBytecodeCompiler {
    ...
    fun compileAndExecuteScript(
        ...
        try {
            scriptConstructor.newInstance(*scriptArgs.toTypedArray())
        }
        catch (e: Throwable) {
    ...
    private fun analyze(environment: KotlinCoreEnvironment, targetDescription: String?): AnalysisResult? {
        val collector = environment.configuration.get(CLIConfigurationKeys.MESSAGE_COLLECTOR_KEY, MessageCollector.NONE)
    ...
    private fun generate(
        ...
        AnalyzerWithCompilerReport.reportDiagnostics(
                ...
                environment.configuration.get(CLIConfigurationKeys.MESSAGE_COLLECTOR_KEY, MessageCollector.NONE))
        ProgressIndicatorAndCompilationCanceledStatus.checkCanceled()
